// Database Utility for Marketplace
class Database {
    constructor(config) {
        this.config = config;
    ...
    isConnected() {
        return (
            this.connection !== null && this.connection.status === "connected"
        );
    }
    ...
    async query(sql, params = []) {
        ...
        if (sql.includes("SELECT") && sql.includes("extensions")) {
        ...
        return [
            {
                ...
                purchasedExtensions: ["plugin-git-tools", "template-web-app"],
                createdAt: new Date("2023-01-01"),
                updatedAt: new Date("2023-08-01"),
